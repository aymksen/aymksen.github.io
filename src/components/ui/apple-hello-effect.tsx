// Ported from 21st.dev — @ncdai/apple-hello-effect
...
type Props = Omit<SVGMotionProps<SVGSVGElement>, "onAnimationComplete"> & {
  /** Higher is faster. */
  speed?: number;
  onAnimationComplete?: () => void;
};

export function AppleHelloEnglishEffect({ className, speed = 1, onAnimationComplete, ...props }: Props) {
